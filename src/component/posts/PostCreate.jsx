...
const PostCreate = ({ onPostSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (post.category === "CARE_REQUEST" || post.category === "CARE_OFFER") {
      ...
      if (post.priceUnit !== "NOT_REQUIRED" && !post.price) {
    ...
    try {
      const postData = {
        ...post,
        region: `${post.province} ${post.city} ${post.district}`,
      };
      ...
      alert(`등록 실패: ${getApiErrorMessage(error, "등록 중 오류가 발생했습니다.")}`);
    }
  };
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <FieldGroup>
            ...
            <ContentField>
              ...
              />
              <Counter>{post.content.length} / 100</Counter>
            </ContentField>
          </FieldGroup>
          ...
          {(post.category === "CARE_REQUEST" ||
            ...
            <CareSection>
              ...
              <div>
                <FieldGroup>
                  <FieldLabel htmlFor="post-content">가격</FieldLabel>
                  <Select
                    name="priceUnit"
                  ...
                  >
                    <option value="NOT_REQUIRED">협의 가능</option>
                    <option value="PER_HOUR">시급</option>
                    <option value="PER_DAY">일급</option>
                  </Select>
                  {post.priceUnit !== "NOT_REQUIRED" && (
                  <TextArea
                    name="price"
                    type="number"
